...
@section("contents")
    ...
    <div class="mh-120vh green spiral-bg position-relative d-flex justify-content-center align-items-center">
        <section class="h-100">
        ...
        <section class="position-relative">
            <div class="px-5 mw-100">
                <div class="row">
                    <div class="col" style="">
                        <div class="row">
                            <img class="img-fluid p-3" src="{{ asset('/images/workshop/fotokiriatas.png') }}" alt="bottom">
                        </div>
                        <div class="row pt-5">
                            <img class="position-relative img-fluid p-3" style="z-index:1;" src="{{ asset('/images/workshop/fotokiribawah.png') }}" alt="bottom">
                    ...
                    <div class="col" style="mind-width:100rem;">
                        ...
                        <img class="fotokanan position-relative img-fluid p-3" style="z-index:1; margin-top:150px; margin-left:20px;" src="{{ asset('/images/workshop/fotokanan.png') }}" alt="bottom">
                    </div>
                </div>
            </div>
        </section>
